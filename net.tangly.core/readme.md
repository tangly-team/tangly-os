...
![Maven Central](https://img.shields.io/maven-central/v/net.tangly/core.svg)
[![javadoc](https://javadoc.io/badge2/net.tangly/core/javadoc.svg)](https://javadoc.io/doc/net.tangly/core)
...
The **tangly core** component provides key abstraction for domain driven development approach and entities with tags and comments.
It requires **Java 14 or higher**.
...
```groovy
    implementation "net.tangly:core:0.2.6"
```

The documentation can be found under [Business documentation](https://tangly-team.bitbucket.io/docs/core/)
