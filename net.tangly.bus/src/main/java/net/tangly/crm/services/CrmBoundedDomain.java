...
package net.tangly.crm.services;
...
import net.tangly.crm.domain.ActivityCode;
import net.tangly.crm.domain.Contract;
import net.tangly.crm.domain.CrmTags;
import net.tangly.crm.domain.Employee;
import net.tangly.crm.domain.GenderCode;
import net.tangly.crm.domain.Interaction;
import net.tangly.crm.domain.InteractionCode;
import net.tangly.crm.domain.LeadCode;
import net.tangly.crm.domain.LegalEntity;
