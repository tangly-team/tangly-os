...
/**
 * The abstraction defines a registered subject entitled to use the application and associated services. The id of the subject is the human-readable unique
 * identifier.
 */
