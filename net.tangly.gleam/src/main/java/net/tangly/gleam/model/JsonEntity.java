 ...
 *   <li>A Java class is inferred from some JSON properties and lookup in the data model. Therefore the import function is specific to the business
...
public record JsonEntity<T>(List<JsonField<T, ?>> properties, Supplier<T> factory, BiFunction<JSONObject, Object, T> imports,
     ...
     *
     * @param properties properties of the Java class to be exported to JSON and imported From JSON.
    ...
    /**
     * Defines a factory method for a Java record mapped to a JSON type. The imports block is custom to handle the construction of a record, the export uses
     * regular mechanisms.
     *
     * @param properties properties of the Java class to be exported to JSON and imported From JSON.
