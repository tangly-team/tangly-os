...
Source Code contributions to this project must be published under Apache 2.0 license.

All documentations and texts to this project must be published under CC-BY-SA 4.0.
...
Documentation Changes::
 The scripts to generate and populate the site from the project clone repository are located under
