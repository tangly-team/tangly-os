...
Team discipline and early warning systems are the key to avoiding such blunders and kill the monster in the egg.
...
Use for example http://hsqldb.org/[hsqldb] for in-memory database and https://flywaydb.org/[flywaydb] to set up the database tables.
====
