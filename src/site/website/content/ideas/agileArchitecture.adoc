...
:description: An introduction to software architecture in agile article development
...
The article launch is a tremendeous success.
You will likely sell the solution for the next ten years.

How shall you define and nurture the software architecture of your article and insure a long living and high quality solution?
...
Their opinionated observations are true for any software article.
It is irrelevant if the article was developed using agile approaches or traditional older ones.

. The sum of all source code is the *true* design blueprint or software architecture,
. The real software architecture evolves (better or worse) every day of the article, as people are *programming*,
. The real living architecture needs to be grown every day through acts of programming by *master programmers*,
. A software architect who is not in touch with the evolving source code of the article is out of touch with reality,
...
You are applying the agile and lean approach to your software article development.
...
Never compromise on your key strategic asset, the source code of your article.
...
And as long as your article contains such code monsters it is worthless to pretend having a nice and thought through architecture.
...
Therefore, the acceptance tests are the living documentation of the behavior of your article.
...
* Lack of accountability equates to lack of trust - your teams are accountable for the quality of your article and you should trust them.
...
You are applying the agile, lean approach to your software article development.
Your teams use Scrum or Kanban to deliver running software every two weeks.

Agile architecture is a key element to improve the quality of your article and reduce cycle time of your article outcomes.
...
We have mentioned refactoring, which is how we evolve an ever-improving design and architecture while building the article incrementally.
