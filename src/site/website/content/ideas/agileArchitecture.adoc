...
Interestingly https://less.works/[LeSS] is more opinionated and describe successful approaches for agile architecture and design.
...
For a detailed discussion consult the post https://tangly-blog.blogspot.com/2018/04/pragmatic-craftsmanship-professional.html[Pragmatic
Craftsmanship].
