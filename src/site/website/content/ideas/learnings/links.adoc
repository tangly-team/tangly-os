...
** Kniberg books link:../lectures/agile-books/ScrumAndXpFromTheTrenches-2nd.pdf[Scrum and XP from the trenches] and
 link:../lectures/agile-books/KanbanAndScrum.pdf[Kanban and Scrum]
