...
....
package net.tangly.bdd [[http://blog.tangly.net/docs/bdd/]] {
}

package net.tangly.commons [[http://blog.tangly.net/docs/commons/]] {
}

package net.tangly.core [[http://blog.tangly.net/docs/core/]] {
}

package net.tangly.dev [[http://blog.tangly.net/docs/dev/]] {
}
net.tangly.dev --> net.tangly.commons

package net.tangly.fsm [[http://blog.tangly.net/docs/fsm/]] {
}

package net.tangly.gleam [[http://blog.tangly.net/docs/gleam/]] {
}
net.tangly.gleam --> net.tangly.commons

package net.tangly.ports [[http://blog.tangly.net/docs/ports/]] {
}

package net.tangly.ui [[http://blog.tangly.net/docs/ui/]] {
}

package net.tangly.erp.crm [[http://blog.tangly.net/docs/erp/crm]] {
}

package net.tangly.erp.invoices [[http://blog.tangly.net/docs/erp/invoices]] {
}

package net.tangly.erp.ledger [[http://blog.tangly.net/docs/erp/ledger]] {
}

package net.tangly.erp.products [[http://blog.tangly.net/docs/erp/products]] {
}

package net.tangly.erp.shared [[http://blog.tangly.net/docs/erp/shared]] {
}

package net.tangly.erp.ui [[http://blog.tangly.net/docs/erp/ui]] {
}
...
The tangly open source components website is hosted under http://blog.tangly.net/docs[Documentation].
