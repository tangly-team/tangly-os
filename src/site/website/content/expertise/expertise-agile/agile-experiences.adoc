...
{ref-scrum} and {ref-less} provide proven approaches and good practices how to efficiently work on one product line with five to hundred product deelopers.
...
At the end you shall deliver a working piece of software delighting your customers.
