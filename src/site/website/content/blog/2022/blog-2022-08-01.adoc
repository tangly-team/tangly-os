...
The laws reflect the difficulty of a sucessfull transformation.
...
See also another blog <<detecting-agile-bullshit>> describing how the department of defense of USA detects agile lies.
