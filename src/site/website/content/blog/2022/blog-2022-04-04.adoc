...
[NOTE]
====
Major product development platforms https://gitlab.com/[GitLab], https://github.com/[GitHub] or https://bitbucket.org/dashboard/overview[BitBucket]
...
image::2022-04-04-elite-dora-success.png[width=90%,height=360,role=text-center]

Elite teams have tremendeous overall performance when improving in the areas tracked through these metrics.
...
Marcel Baumann. 2020
- [[[how-healthy-is-your-product, 5]]] link:../../2018/how-healthy-is-your-product-delivery-pipeline-check/[How Healty is Your Product Delivery Pipeline]
Marcel Baumann. 2018
