...
tags: ["agile"]
params:
  featured: "blog/2022/pics/2022-07-01-head.png"
---
...
{ref-scrum} is the most popular approach to creating awesome new digital products.
...
If you are the type who secretly wants to eliminate all uncertainties, you will either be frustrated as a Scrum master or will drive your team crazy in pursuit of an impossible goal
...
Yu should certainly know the official {ref-scrum}.

[IMPORTANT]
====
You are a professional Scrum master in digital product development when:

- You understand the _Definition of Done_ of your team.
...
You can find all these documents in less than two minutes.
Better would be to display them on the sprint board.
====

== Things Scrum Masters Never Do

You are a Scrum master.
You are *not* a secretary or an administrator.
...
The Scrum master is no longer necessary to resolve communication roadblocks and resolve issues.
