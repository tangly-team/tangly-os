...
params:
  featured: "blog/2022/pics/2022-03-01-head.png"
---
...
A clear sign of dysfunctional Scrum is when the content and the priority of backlog items are never updated during a sprint review.
...
If your Scrum masters or product owners have only attended the initial two days training and never continued on the path, they are laypersons. +
