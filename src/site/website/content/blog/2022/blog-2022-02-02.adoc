...
tags: ["agile"]
params:
  featured: "blog/2022/pics/2022-02-02-head.jpg"
---
...
The majority of software product development initiatives use an agile approach.
...
Awareness that talent can be found at any location speeds up the trend.
--
...
* Enhancement of scalability and rapid elasticity (54%) _means the organization is slow to react_.
...
|An external team is fully responsible for building the team and developing the product from discovery to final release.
...
Nearshore locations are located in or near Europe, making it easy to reach it from most European cities via air connection As a European nation.
...
The location of documents, source code, and artifacts should have the same availability and comfort for all members.
Company Binding::
...
. Provide the same training, certifications, and conference access to all developers?
. Support meritocracy?
...
I also observe that quite a few teams are heavily distributed geographically and often live in different countries.

This constellation is not more a nearshore team.
The organization has moved to an all-remote setup without a common office location
footnote:[Companies such as GitLab, SonarCloud, and Atlassian adopted this model years ago.].
