...
* [[[domaindrivendesign, 1]]] Domain-Driven Design: Tackling Complexity in the Heart of Software. Eric Evans. Addison-Wesley. 2004.
* [[[implmentingddd, 2]]] Implementing Domain-Driven Design. Vernon Vaughn. Addison-Wesley. 2013.
* [[[ddddistilled, 3]]] Domain-Driven Design Distilled. Vernon Vaughn. Addison-Wesley. 2016.
