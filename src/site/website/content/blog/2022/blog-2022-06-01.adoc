...
_A major gaal is to avoid any tainting of the core domain model from other layers._
...
The DDD approach emphasizes systematic refactoring and code improvements cite:[refactoring,clean-code,clean-coder,clean-architecture].
