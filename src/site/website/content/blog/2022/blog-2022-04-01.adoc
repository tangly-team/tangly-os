...
A learning approach is to learn more about Groovy and Clojure.
...
One major focus is the functional programming approach and how it impacts design and development activities.
...
switch <value> {    // <2>
    ...
    case value instanceof <type> && <condition> -> <expression>;
...
Clojure provides a tail recursion optimization mechanism the programmer has to explicitly call.
