...
A professional developers should know agile methods which are around since this millennium:
...
* Is she experienced with integrating relational database in Node.js backend solutions?
