...
You only need to take a five-minutes walk.
...
I pack the notebook, a mouse, a keyboard, a power supply and some adapters.].
...
All collaborators indentify with these values and apply them in our daily work.
