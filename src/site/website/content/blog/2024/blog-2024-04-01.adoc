...
Complex or slow algoritms shall be parallelized using structured concurrency to exploit modern multicore processors.
====
...
Modern Java cpde processeses any collection through sreams.
