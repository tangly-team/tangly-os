...
The actor abstraction structure is
...
Two major approaches exist to implement these timeout dependencies.
...
More comlex state machines can be implemented with the help of statechart notation <<finite-state-machines>>.
...
Marcel Baumann. 2024.
-[[[finite-state-machines, 2]]] link:../../2024/nice-statechart-diagrams/[Finite State Machines]
Marcel Baumann. 2024.
