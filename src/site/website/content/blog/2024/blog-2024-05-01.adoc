...
Below an example of a software architecture document content
footnote:[I add a chapter describing the user manual and user interface when document our applications.].
...
footnote:[The worst solution is to write Microsoft Word documents and store them in a SharePoint site.
...
footnote:[JavaDoc lately added support to Markdown syntax and code snippets.
