...
tags: ["java", "tangly"]
params:
  featured: "blog/2024/pics/2024-05-03-head.jpg"
---
...
I love to solve problems and provide cool solutions to users
cite:[facts-and-fallacies-software-engineering].

I love my software development job.
I am already sixty years old.
...
I love to work with other developers and to coach them to become better software engineers.
Some of the products I developed last millennium are still in use today.

I love technology and I work to improve live quality for humanity
footnote:[I can buy all my public transportation tickets with my mobile phone.
Or I can just swipe my phone and ride the bus or train.
The application will track my movements and select the cheapest ticket for the commute.
These features improve my quality of life.].

I love to develop software applications and see how it helps customers
footnote:[My preferred technology stack is the Java ecosystem.
The numerous open source libraries tremendously simplify the creation of complex products.].
--

[quote,Definition of Nerdy]
____
...
The mobile app guides me effortlessly to my destination.
This is measurable progress for millions of people.
And it saves trees and ink because nobody prints maps anymore.

== Software Engineer

I found out the only drawback of my job in Switzerland is the age discrimination.
It is challenging to get hired as a software developer when you are more than fifty years old.
I am now sixty years old.
The Swiss companies are bigots and prefer to hire young people.
...
I thrive with domain-driven design approaches and clean architecture.
The available technical stacks and libraries are so powerful.
I can develop complex applications in a fraction of the time it took me twenty years ago.
My productivity is much higher than it was in the last millennium.

I use the Java technical stack for almost all my development activities.
I mostly develop internal and management applications.
{ref-vaadin} is my preferred technology for creating user interface.
I wrote all the user interface code in plain Java for modern browser-based solutions.
...
Teaching is a beautiful and rewarding activity.
But it is sometimes frustrating.
I am living in Switzerland, and the education system is not the finest for technical education.
It is a country with neither a STEM strategy at federal nor state education level.
We are exceedingly missing young people with training in science, technology, engineering, and mathematics.
