...
footnote:[Beware that browser-based JavaScript solutions require major rework of the solution at least every eighteen months.
...
{ref-ddd} is a proven good practice for designing the domain model and partioning your solution.
