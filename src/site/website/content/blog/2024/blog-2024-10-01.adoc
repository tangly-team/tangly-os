...
The introduction of the Euro was the end of quite a few currencies._
...
The signification of a code type is hard-coded in the software.
The set of values for a code type is customer-specific.
Tags::
...
<1> The entity interface defines the basic properties of a value entity.
A concrete implementation of an entity can be a Java record.
