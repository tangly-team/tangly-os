...
The vision and goals of the project should always contain an overall planning frame. During the project empirical evidence will trigger revision of the
...
So at the end of sprint all stories realized since the start of the project must be correct.
