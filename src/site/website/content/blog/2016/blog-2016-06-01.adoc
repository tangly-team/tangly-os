...
The vision and goals of the outcome should always contain an overall planning frame. During the outcome empirical evidence will trigger revision of the
...
So at the end of sprint all stories realized since the start of the outcome must be correct.
