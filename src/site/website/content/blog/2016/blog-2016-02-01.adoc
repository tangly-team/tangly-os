...
tags: ["agile"]
params:
  featured: "blog/2016/pics/2016-02-01-head.jpg"
---
...
Suddenly, everyone can see your code, so at the beginning you as a developer must cope with different views on how good code should be written.
...
You have to realize you are not a master.
You are the enabler for a team of talented engineers.

So you need to discover your song _the lonely cowboy riding in the sun_ why this job is so rewarding.
...
See, for example, the discussion about the https://less.works/less/management/index.html[manager role in an agile environment] in the {ref-less} approach.
