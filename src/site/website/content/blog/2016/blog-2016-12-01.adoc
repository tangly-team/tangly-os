...
tags: ["agile"]
params:
  featured: "blog/2016/pics/2016-12-01-head.jpg"
---
...
This is in general an excuse to state that {ref-scrum} alone cannot work and classical product leaders are still necessary.
...
The PMI-ACP is working on integrating agile approaches into the official PMI approach.

An official definition of Scrum and the responsibilities of the team, product owner, and Scrum master are documented in {ref-scrum}.
