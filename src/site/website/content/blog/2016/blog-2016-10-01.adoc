...
. Changes during the outcome (62% Computer, 48% Experteer)
 _Agile and Scrum welcomes changes in the outcome. It is one of the four mantra of the Agile Manifesto. All agile processes are optimised to support changes._
. Unclear outcome definition form the business stakeholders (50% Computer, 43% Experteer)
 _Scrum requests a clearly stated vision, roadmap and story map of the outcome._
 _The Scrum board is a radiator to communicate the outcome vision, goals, and motivations to all interested parties._
. Insufficient outcome management and controlling (40% Computer, 4847 Experteer)
 _Scrum team, product owner, and Scrum master have clear responsibilities for outcome management._
