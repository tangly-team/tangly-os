...
Scrum sees the importance of quality like the lean production approach.
...
These documents are also TUV and https://en.wikipedia.org/wiki/Food_and_Drug_Administration[FDA] compliant.
