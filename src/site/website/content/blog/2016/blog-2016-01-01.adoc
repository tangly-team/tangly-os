...
They are spending money you cannot invoice to your customers.
...
We have experience working with quality insurance and https://en.wikipedia.org/wiki/Technischer_%C3%9Cberwachungsverein[TUV] or https://en.wikipedia.org/wiki/Food_and_Drug_Administration[FDA] regulatory departments.
...
You can satisfy your QA and regulatory stakeholders with a lot of reports nobody will ever read.
