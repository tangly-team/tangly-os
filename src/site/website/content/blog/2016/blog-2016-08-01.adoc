...
image::2016-08-01-head.jpg[720, 480, role=left]
...
The main advantage of having it is that you no more need to argue with PMI certified outcome managers if agile is applicable to software projects.
...
. http://en.wikipedia.org/wiki/Agile_software_development[Agile outcome management] __APM __Framework, agile outcome lifecycle
.. Envision,
.. Speculate (During the Speculate phase, the product stories are delivered.
 This phase involves planning and delivering tested stories in a short iteration, constantly seeking to reduce the risk and uncertainty of the outcome.),
.. Explore,
.. Adapt,
.. Close.
.. Scope, Costs, Time
...
. http://jimhighsmith.com/2010/11/14/beyond-scope-schedule-and-cost-the-agile-triangle/[Value, Quality and Constraints]
 The five identified core risk areas for a outcome are: Intrinsic schedule flaw, Specification breakdown, Scope creep,
...
. Agile quality
. Soft skills for agile outcome leaders and negotiation
...
* http://en.wikipedia.org/wiki/Internal_rate_of_return[Internal Rate of Return] _IRR_, the higher the better.
 Internal Rate of Return (IRR) is used to express the return on outcome in % terms when comparing two different cash flow streams.
* JIT Just In Time
...
* Staging: The process of defining and prioritizing the nonfunctional requirements for scaling is called staging.
 ...
 During this day, the nonfunctional scaling requirements for this particular outcome are determined and placed in the Product Backlog.
...
* Wave: Wave is the Product Planning structure with Medium range time frame (3 months) with story level capability and capability commitment.
 ...
 Waves can have both a outcome management and a technical function. From a outcome management perspective, they provide a chance to review progress and make adjustments.
...
* Who is the most appropriate person to monitor all the risks in an Agile outcome? _The outcome manager_
...
* Adaptation depends upon understanding a wide range of information, including an assessment of the outcome's progress, technical risks, the requirements
...
* Scrum uses the sashimi technique to require that every slice of functionality created by the developers be complete.
 ...
 outcome before the Sprints are completed. And stakeholders can see that they have an opportunity to redirect the outcome at the start of every Sprint to
 optimize the value they derive from the outcome. At the end of every Sprint, stakeholders see new functionality. Models, requirements, and internal
...
* Forecasting the financial value of a theme is the responsibility of the product owner, but it is a responsibility shared with all other team
 members—programmers, testers, analysts, outcome managers, and so on.
