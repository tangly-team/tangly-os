...
.. Close.
.. Scope, Costs, Time
.. http://jimhighsmith.com/2010/11/14/beyond-scope-schedule-and-cost-the-agile-triangle/[The agile triangle]: Value (releasable product), Quality (reliable, adaptable product), Constraints (cost, schedule, scope)
...
.. Problem to Solve (Good Teams) -> Collaboration, consensus Collaboration- Seeking a win-win situation.
...
** 0 = "I'd have been better off making a Starbucks run.
...
About as valuable as if I'd been coding" or Received Benefit Equal to Time Invested High Return on Investment
** 3 = "Surprisingly, this was more valuable than if I'd been writing code"
** 4 = "Wow, this meeting saved me tons of time.
Thank goodness I didn't skip it to code" or Received Benefit Greater than Time Invested
