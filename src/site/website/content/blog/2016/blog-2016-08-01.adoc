...
tags: ["agile"]
params:
  featured: "blog/2016/pics/2016-08-01-head.jpg"
---
...
* The acronym _DEEP_ Detailed Appropriately, Estimable, Emergent, Prioritized. Split the story into smaller stories.
...
* http://en.wikipedia.org/wiki/Earned_value_management[Earned Value Management] _EVM_ - this is the standard PMI theory -
...
About as valuable as if I had been coding" or Received Benefit Equal to Time Invested High Return on Investment
...
Becoming one with a spirit alone without clinging to forms; transcending the physical
* {ref-scrum}
...
Below are some additional definitions
...
Sprints are kept short enough that the stakeholders do not lose interest in the product before the Sprints are completed.
...
Models, requirements, and internal artifacts might be of use to the developers, but they are never shown to the stakeholders.
...
It is a voting scheme where each stakeholder is given 100 points that he or she can use for voting in favor of the most important requirements.
