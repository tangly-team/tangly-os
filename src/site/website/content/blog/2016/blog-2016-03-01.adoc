...
tags: ["organization"]
params:
  featured: "blog/2016/pics/2016-03-01-head.jpg"
---
...
I struggled for days to have the correct drivers for the graphic card and communication components of my notebook.
...
These computers were used daily for the first five years.
...
* Atlassian Cloud applications based on BitBucket, HipChat, CI pipeline,
* {ref-homebrew} as the package manager for utilities,
* Docker as the container manager,
* VirtualBox when I need a full-fledged virtual machine
footnote:[The need for virtual machines for daily work is fading away.].
