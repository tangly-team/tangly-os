...
tags: ["agile"]
params:
  featured: "blog/2016/pics/2016-04-01-head.jpg"
---

include::../fragments/_config-mb-blog.adoc[]

:ref-unified-process: https://en.wikipedia.org/wiki/Unified_process[Unified Process]
:ref-waterfall-model: https://en.wikipedia.org/wiki/Waterfall_model[Waterfall Model]
:ref-v-model: https://en.wikipedia.org/wiki/V-Model_(software_development)[V Model]
...
Interestingly, these people also state that the same problems exist with traditional approaches such as {ref-unified-process}
footnote:[The eclipse foundation had a project called OpenUP which was a lightweight version of the Unified Process.],
{ref-waterfall-model}, {ref-v-model} defined as a formal standard in Germany
...
Do not expect pre-cocked solutions, but a tool set how to lead successfully such projects.
...
Lisa Crispin and Janet Gregory provide insights and a proven track on how to guaranty agile quality assurance and agile testing.
...
I know quite a few developers are shocked by his requirements.
...
* Scrum and XP from the trenches: How we do Scrum, Henrik Knieberg, InfoQ 2007 is a short book on how to implement Scrum and XP in projects
...
You find a more complete book list under link:{ref-tangly-blog-url}/ideas/learnings/books[Books].
