...
params:
  featured: "blog/2016/pics/2016-11-01-head.jpg"
---
...
They have an understanding of agile software development techniques such as {ref-scrum}, {ref-lean}, {ref-kanban}, {ref-xp} but no clue how a company could
be agile.
...
Processes change regularly bottom-up, a company’s budget can only be a rolling indicative budget, and planning has to be _continuously_ updated.
...
Focus::
You daily optimize the customers’ value and thrive for excellence.
...
The https://modernagile.org/[modern agile movement] defines guiding principles.
...
Maintain sustainable pace and stability, all divisions of the organization should focus on customer value.
...
* _Be agile_ instead of _doing agile_.
...
* _Compliment every collaborator_ you are working with at least once a week instead of _evaluating weaknesses and criticizing people_.
Do you lead by example?
* No management by objectives _MBO_ or bonuses are established in your company
* Every collaborator has access to all company data, every collaborator can request process and tool changes.
We favor _Individuals and interactions over tools and processes_
...
I cannot understand other reasons to spend 40 hours and more per week on something less valuable.
...
You can delve into empirical evidence and discussions in books written by business management professors, CEOs, and passionate agile advocates.
Below is a list of mind openers (available as Amazon ebooks):
