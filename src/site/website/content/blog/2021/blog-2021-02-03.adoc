...
tags: ["agile"]
params:
  featured: "blog/2021/pics/2021-02-03-head.jpg"
---

include::../fragments/_config-mb-blog.adoc[]
:ref-ics: https://en.wikipedia.org/wiki/ICalendar[ICalendar]
...
Here is a little advice to improve our work experience.

== Schedule an Appointment

If you are responsible for the meeting preparation, please:

* Send me a calendar invitation in the {ref-ics} format.
...
** An attendee list, normally visible in the {ref-ics} invitation.
...
The rules to sharing a document are:
...
The rules to editing a document are:
