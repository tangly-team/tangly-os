...
tags: ["agile"]
params:
  featured: "blog/2021/pics/2021-12-01-head.png"
---
...
I do not think you can really understand what it is like to work at Spotify without actually living it.
...
image::2021-12-01-failure-culture.png[width=90%,height=360,role=text-center]
...
Like Scrum teams, squads are cross-functional and self-organizing.
They are responsible for end-to-end delivery of a complete project. +
_Are your “squads” self-organizing?_ _Are they capable of end to end delivery or do you have hand-offs to other teams or departments?_
...
Autonomy helps to scale because they do not need as much central function.
...
Managers paint the big picture but do not tell people how to solve it.
...
No Magic in terms of Squads and Tribes::
Henrik said he was not sure why they used weird words like Squads and Tribes.
The label itself means nothing.
Each tribe is a cross-functional team vertically aligned for delivery. +
...
They are not functional departments, they are volunteer-led communities based around particular expertise. +
...
Decoupled Releases and CI/CD Reduce Cycle Time::
...
Transparency is one of the pillars of Scrum and essential for agility.
Transparency is also an enabler for self-organization.
Similarly, short feedback loops provide opportunities for inspection and adaptation.
Fast feedback ensures teams are building the most valuable features. +
...
They think it is better for managers to ask teams how they can help, rather than asking people what they are working on or when they will be done. +
...
Spotify Hack Week::
Twice a year Spotify hosts a hack week when they let everyone work for a week on whatever they want.
...
Teams establish “Keep List” which may include things like: Retros, daily stand-ups, Google Drives, GIT, and Guild UnConferences.
...
After all, without a vision for awesomeness, you likely will not get there.
