...
params:
  featured: "blog/2021/pics/2021-04-02-head.jpg"
---
...
The advantages of providing a self-service kiosk for users in an academical or industrial environment are:
...
The provided self-service products shall cover at least 80% of customer's needs.
...
The images shall be accessible from the company Intranet and often from the Internet.
...
Most often, virtual images are only necessary when the user needs a Microsoft or macOS environment.
