...
tags: ["agile", "devops"]
params:
  featured: "blog/2021/pics/2021-08-02-head.png"
---
...
_You will define cross-functional teams as documented in the {ref-scrum}._
====
...
They do need to interact manually to set up and configure resources.
