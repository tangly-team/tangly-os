...
tags: ["java"]
params:
  featured: "blog/2021/pics/2021-03-01-head.jpg"
---

:ref-amber: https://openjdk.org/projects/amber/[Amber]
:ref-coin: https://openjdk.org/projects/coin/[Coin]
:ref-jetbrains: https://www.jetbrains.com/[JetBrains]
:ref-jacoco: https://www.eclemma.org/jacoco/[JaCoCo]
:ref-slf4j: https://www.slf4j.org/[slf4j]

include::../fragments/_config-mb-blog.adoc[]

[.float-group]
--
image::2021-03-01-head.jpg[width=420,height=360,role=left]

Java development activities have won traction since the decision to release a new version to the community every six months.
Preview and incubator features promote feedback from the community and users.

Some tool builders, such as {ref-jetbrains} are working proactively and provide support for JDK in developments.

Other tool maintainers such as {ref-jacoco}  are dreadfully behind the release cycle.
...
Programmers learnt in the last decade that legibility and brevity of programming languages matter.
The Java {ref-coin} and {ref-amber}
...
_The Booch Ada component library has supported internal iterators since 1985_.
Record::
...
* Missing logging interface similar to {ref-slf4j}.
