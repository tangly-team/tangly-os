...
params:
  featured: "blog/2021/pics/2021-06-02-head.jpg"
---
...
The leadership behavior of your colleagues is only changing slowly.
...
is only necessary because the administration is strongly hierarchical and unable to adapt to the changes over the development of the solution.
...
The SwissQ report provides empirical data on where Swiss companies stood in 2021
...
I wish a fruitful and successful transformation to a better way of working and of creating awesome products.

You can download the Trends Benchmark Report 2021 from SwissQ footnote:xebia[].
