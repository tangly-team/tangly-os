...
--- Agile Approaches
--- Diagrams (BPML) <<hslu>>
---- //BPMN Sketch Minere//<color:green>
-- Design <<hslu>>
...
* https://bitbucket.org/dashboard/overview[Bitbucket] closed source solution of Atlassian.
CI and CD pipelines are part of the product.
...
They slowly open their prodcut to additional development stacks such as Java, Python.
...
The current most used tool is https://en.wikipedia.org/wiki/Git[Git].
...
[source, shell]
----
# ...develop some code and commit it in the currently selected my-branch
git commit –m "Some commit message"

# switched to branch 'trunk'
git checkout trunk

# merge the branch "my-branch
$ git merge my-branch
----
