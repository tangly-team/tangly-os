...
params:
  featured: "blog/2021/pics/2021-01-03-head.jpg"
---
...
* https://github.com/[GitHub] is a closed-source solution and the most well-known solution.
...
Our students can more easily bridge between academical teachings and industrial practices and acquire a deeper understanding of DevOps and agile practices.
...
Studying the history of software development practices shows the rise and fall of https://en.wikipedia.org/wiki/Source_Code_Control_System[SCCS],
...
IntelliJ has native support for {ref-markdown} and an excellent plugin for {ref-asciidoc}.
...
Merge your branch _my-branch_ back into the _trunk_
...
<3> Merge the branch _my-branch_ into the _trunk_.
...
If you rebase a branch that was pulled from {ref-github} or {ref-gitlab} and then push it back, the server will reject it.
...
So let us see how to squash the last three commits to a single commit.
...
Sadly, students rarely work in teams during their studies.
