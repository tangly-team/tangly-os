...
As much as possible try to use global externally defined identifiers.
...
If your identifiers are strings, you shall clearly defined the supported languages, and character sets.
