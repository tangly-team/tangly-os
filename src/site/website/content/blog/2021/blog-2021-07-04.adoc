...
tags: ["agile"]
params:
  featured: "blog/2021/pics/2021-07-04-head.jpg"
---
...
The first steps to becoming a great product owner are described in this article.
...
.. describe at least three attributes of a https://scrumguides.org/scrum-guide.html#product-backlog[Product Backlog] item that help assess the maximizing outcome
...
.. create at least one https://scrumguides.org/scrum-guide.html#product-backlog[Product Backlog] item that includes a description of the desired outcome and value.
...
I published a list of seminal works for interested product owners under link:{ref-tangly-blog-url}/ideas/learnings/books/#_product_owner[Books].

== Requirement Engineering Training

The most relevant organization is Europe is the {ref-ireb} _IREB_.
...
* HSLU https://www.hslu.ch/de-ch/hochschule-luzern/weiterbildung/cas/[CAS Requirement Engineering]
