...
The fist steps to become a great product owner are described in this article.
...
You should read the recommended books to have a greater probability to pass the examination._
...
Each certification organization has own rules and conditions._
...
The https://www.scrum.org[Scrum.org] certifications do not expire.
...
You can self-study the Scrum Product Owner objective with the official product owner book<<product-owner>>.
...
The requirements engineering community is well on the path to agility.

image::2021-07-04-irep.png[width=420,height=360,role=left]

The certification is often a prerequisite to be hired for requirements engineer job.
...
Similar technical university formations are provided for user interface design and usability engineering.
