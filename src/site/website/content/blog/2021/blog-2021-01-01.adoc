...
:ref-eclipse-store: https://eclipsestore.io/[Eclipse Store]
...
A workable approach is described and implemented with the open source component {ref-tangly-doc-url}/gleam/[Gleam].
...
We encourage experimenting with the {ref-microstream} approach for small projects footnote:[The Eclipse foundation took over the MicroStream library in 2023 under the new name {ref-eclipse-store}.
