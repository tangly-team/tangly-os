...
tags: ["agile"]
params:
  featured: "blog/2021/pics/2021-06-01-head.jpg"
---
...
Time is measured in years, not in days.
...
=== Shift Team Culture: _Focusing_ teams produces business value (6 months)

The team generates their own day-to-day tasks and plans based on their business representative’s needs.
...
The {ref-scrum} defines roles and events enabling a team to achieve the goals of the first zone.
...
Employees, customers, and stakeholder satisfaction is high._
...
A team that gains or loses too many members may have trouble sustaining what it learned.
This is a particular problem for organizations that assemble new teams for every project.
Agile Fluency and Scrum::
Agile and Scrum require long-living and stable teams.
...
The {ref-less} community is vocal how destructive the wrong management decision can be.
