...
params:
  featured: "blog/2021/pics/2021-05-01-head.jpg"
---
...
Indeed, you have successfully implemented the first steps.
...
Download is available under from SwissQ
footnote:xebia[The SwissQ company was acquired by https://xebia.com/switzerland-de/[Xebia] and access to the data was removed.
...
The competitive advantage is now to implement an agile product value stream through the whole organization.
Fast delivery to customers and pivot to disruptive changes are the new key for extraordinary growth and success.
The rise of digital and Internet affine banking solutions is such a transformative example.
...
It means an agile team has a 25% higher relative probability to be victorious than classical teams (_50.5% versus 39.5%_).
...
Remember, it is not Kanban if it does not have WIP limits.
...
____
It is not about changing agile to fit your company.
...
However, the change often does not go beyond the first application of the methodology.
...
You can download Trends Benchmark Report 2020 from SwissQ footnote:xebia[].
