...
- Declare and instantiate Java objects including nested class objects, and explain the lifecycle of an object (including creation, dereferencing by reassignment, and garbage
collection)
...
The material is basic and do not always reflect the current state of the Java ecosystem.
