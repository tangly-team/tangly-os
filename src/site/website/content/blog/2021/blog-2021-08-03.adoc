...
tags: ["agile"]
params:
  featured: "blog/2021/pics/2021-08-03-head.png"
---
...
Here the official definition of the product owner role taken from the {ref-scrum}.
...
* Helping employees and stakeholders understand and enact an empirical approach to complex work; and,
...
_It is usually two days of training.
The https://www.scrum.org[Scrum.org] allows taking the certification examination without attending a course_
footnote:[The examination is only available in English.].
...
.. discuss the focus of the activities for the Product Owner and Development Team during the two topics of Sprint Planning: the _What_ and the _How_.
...
.. describe at least two approaches to conducting a Sprint Retrospective.
...
.. explain the importance of a strong definition for _Done_ and describe at least two risks associated with a weaker definition of _Done_.
...
https://www.scrum.org/resources/suggested-reading-professional-scrum-master[Suggested Reading Professional Scrum Master]. Seminal cited books are
cite:[scrum-managing-for-results,scrum-pocket-guide-3rd].

I published a list of seminal works for interested Scrum masters under link:{ref-tangly-blog-url}/ideas/learnings/books/[Books].

== Project Leadership Training

image::2021-08-03-pmi-talent-triangle.png[width=420,height=360,role=left]

An interesting development is the addition of tailored project management training emphasizing agile approaches.
...
* FFHS https://www.ffhs.ch/en/degree-programmes/[CAS Agile Organization]
