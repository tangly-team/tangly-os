...
A nice overview was published in the _Professional Product Owner_ cite:[professional-product-owner] written by the stewards of the product owner certification path of https://www.scrum.org[Scrum.org].
...
Agile requirements engineers can found valuable information in seminal books
