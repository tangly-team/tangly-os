...
- [[[howtoleadinproductmanagement, 7]]] How To Lead in Product Management: Practices to Align Stakeholders. Guide Development Teams and Create Value
Together. Roman Pichler. 2020
- [[[buildingevolutionaryarchtitectures, 8]]] Building Evolutionary Architectures: Support Constance Change. Neal Ford. Rebecca Parsons & Patrick Kua.
O'Reilley. 2017
