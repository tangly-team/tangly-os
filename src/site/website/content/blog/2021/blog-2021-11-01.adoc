...
params:
  featured: "blog/2021/pics/2021-11-01-head.jpg"
---
...
You are responsible for adding the missing pieces to improve your development organization and remove your specific impediments.

What are the advantages to taking a goal-driven approach?
...
Our philosophy is to look for great ideas regardless of their source and to recognize there are no best practices.
...
For each facet of the exploration we have a set of methods to work with.
...
I think that the figures below make it very clear how people are enabled to make intelligent process decisions.
...
A team in a regulatory environment will make different decisions, particularly around the amount of detail, than teams in non-regulatory environments.
These are just three of several scaling factors (more on this in a future blog posting, although you may find my agility at scale blog to be of interest).
...
Shouldn’t the toolkit cover a wider range of issues, such as leadership and requirement management as Scrum does, technical issues as XP does, modeling and documentation as Agile Modeling does, and many other issues?
...
We suggest that in the case of issues where the options are ordered there is clearly an indication of agile maturity or sophistication.
...
The palette of approaches for a facet of your process was exemplary shown above.
