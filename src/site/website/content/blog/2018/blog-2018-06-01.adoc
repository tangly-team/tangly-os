...
I encounter organizations stating that zero defects as measured with SonarQube is the ultimate goal - and they find normal to have a hundred of thousands of smells -.
