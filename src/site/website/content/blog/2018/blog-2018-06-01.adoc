...
image::2018-06-01-head.jpg[720, 480, role=left]
Lately I was asked how many bugs and smells detected through SonarQube were acceptable for a software article.
...
But first that does it means to have a quality software article?

[quote]
____
A high quality software article has no catastrophic failures, and seldom bad behavior.

It is maintainable and extendable with new technologies and new features.
____

The first part is called extrinsic quality and is why customers buy your article.
The second part is called intrinsic quality and is why customers buy your article again and recommend it.
...
* Clean architecture and domain driven development - You guarantee the article is extendable.
...
I find intolerable to hear software professionals stating they are not in charge of the intrinsic quality of the article they write.
...
The first steps to improve your article are quite simple are around for at least twenty years.
