...
params:
  featured: "blog/2018/pics/2018-12-01-head.png"
---
...
Risk List::
You have a documented risk list with description of risks, probability of occurrence and cost per event, and mitigation measures,
...
Remember an agile product needs an https://en.wikipedia.org/wiki/Agile_Architecture[agile architecture].
