...
For this, it analyzes all the source lines of your outcome on a regular basis.
...
You are free to analyze a single file, a package, or the whole outcome; you can also exclude files or packages from the analysis.
...
.. configure the SonarCube instance to synchronize the rule set used in your outcome
