...
tags: ["design", "java"]
params:
  featured: "blog/2018/pics/2018-05-01-head.png"
---
...
Issues marked as Will not Fix or False Positive in SonarQube or SonarCloud disappear from your IDE.
...
This approach guarantees you always release source code with fewer SonarCube issues.
SonarCube always shows no findings for new code and for refactored code.

And you have made a step on the journey to become a professional software developer and achieve
