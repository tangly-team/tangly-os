...
image::2018-10-01-head.png[role=left]
...
Any project should have a battery of measures deployed to continuously monitor the source code and detects trends over time.
