...
tags: ["agile"]
params:
  featured: "blog/2018/pics/2018-11-02-head.png"
---
...
Personally I prefer the {ref-less} approach, but I respect your choice - {ref-safe},
...
It is a waste to have huge quarterly PI gatherings and plans just to discard them after the next DevOps finding.
You should probably update your PI roadmap.
