...
tags: ["agile"]
params:
  featured: "blog/2018/pics/2018-01-02-head.jpg"
---

include::../fragments/_config-mb-blog.adoc[]

:ref-tdd: https://en.wikipedia.org/wiki/Test-driven_development[test-driven development]
:ref-ci: https://en.wikipedia.org/wiki/Continuous_integration[continuous integration]

image::2018-01-02-head.jpg[width=420,height=360,role=left]

You work using agile and lean approaches.
Your collaborators are trained how to use agile principles.

Techniques such as {ref-tdd},  {ref-ci}, {ref-devops} or clean code are regularly practiced.
...
How can your team improve your product and increase customer value?
...
[WARNING]
====
Hold meetings with key stakeholders of the organization.
Get a better understanding of the organization's goals and the current situation.

Find out why they introduced agile and Scrum.

Ask them why they are performing the agile assessment and what expectations they have.

_Evaluate if the assessment is a mere formality or if the organization is really interested in improving._

_Beware that sometimes the assessment is a cover for a reorganization or a cost-cutting measure._
====
...
* Record Scrum meetings.
The sprint planning, sprint review, sprint retrospective, daily scrum, and if necessary, backlog refinement should be recorded for analysis.
* Observe how the team members work during the sprint to better understand the dynamics in your team. +
How are they collaborating with Chat tools, Git platforms? +
How do they do pair programming, design workshops, and merge requests?
* Analyze the vision, roadmap, release plan, product backlog the product owner communicated to the team and to the organization.
* Analyze the impediment list together with the Scrum master and product owner.
* Review the definition of done _DoD_ of the teams.
