...
tags: ["agile"]
params:
  featured: "blog/2018/pics/2018-04-02-head.jpg"
---
...
** A team is stable, *long-lived, collocated, cross-functional,* and implements end-to-end features for the solution.
...
** Project managers are unnecessary in an agile organization.
...
A huge advantage of https://less.works[LeSS] is that it is {ref-scrum}.
You do not need to learn new methodologies, terminology, or processes.
Apply all your hard-earned learnings from your Scrum transformation.
