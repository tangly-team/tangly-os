...
Architecture Decision Record ADR is a compact and traceable documentation of all important decisions taken during the realization of a article.
...
You can also track your decisions without any tools, a regular article has often less than hundred decisions.
