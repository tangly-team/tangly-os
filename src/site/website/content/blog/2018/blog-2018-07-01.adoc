...
You can add to the same git repository as the outcome, visualize differences and if desired generate a nice looking document.
...
This section describes the forces at play, including technological, political, social, and outcome local.
...
==== Status
A decision may be "proposed" if the outcome stakeholders haven't agreed with it yet, or "accepted" once it is agreed.
...
A particular decision may have positive, negative, and neutral consequences, but all of them affect the team and outcome in the future.
