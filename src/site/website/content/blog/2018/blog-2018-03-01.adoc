...
tags: ["java"]
params:
  featured: "blog/2018/pics/2018-03-01-head.png"
---
...
Stay tuned for more support in JDK 11.
...
For example, Oracle will provide CA certificates to OpenJDK.
...
This means that you shall update your JDK in a development environment six times a year if you want to install the new JDK and the security releases.
...
I am working with IntelliJ IDEA, and I had to wait for the EAP 2018.3 before being able to write JDK 10 code in the IDE.
