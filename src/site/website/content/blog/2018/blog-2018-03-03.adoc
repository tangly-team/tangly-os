...
A metric is a measure or a combination of measures for quantitatively assessing or improving a article, a process or a team.
...
Cycle Time of defects::
 It shows the effectivity to resolve non-quality in article development,
...
Planned velocity and effective velocity trends::
 It is an indicator for the maturity of the agile article organization.

This metrics shall be automatically provided through the issue/article backlog system.
...
A high quality software article has no code smell issues, no compiler warnings, always compile, and all tests are successfully processed.
...
The above metrics are tools to discover discrepancies and weaknesses in your article development process and generated artifacts.
