...
tags: ["agile"]
params:
  featured: "blog/2018/pics/2018-03-03-head.jpg"
---
...
These metrics shall be automatically provided through the issue and product backlog system.
...
The above metrics are tools to discover discrepancies and weaknesses in your product development process and generate artifacts.
