...
tags: ["agile"]
params:
  featured: "blog/2018/pics/2018-09-01-head.png"
---
...
This model also maps very well to the _Awareness – Desire – Knowledge – Ability – Reinforcement_ or ADFAR model.
...
The major activities are to align the collaborators and provide the necessary knowledge through training and hands-on exercises.
...
Second, they train the team members how to use learnt techniques such as clean code, pair programming, pair check-in, agile architecture, requirement elicitation, test driven development, agile quality assurance, acceptance test driven development, continuous integration, deployment, and delivery.
...
. An Agile and Scrum coach is responsible for six to eight Scrum teams.
...
The problem is that most of the organizational impediments are driven by cultural values deep within the organization.
...
Here is a checklist example to reflect why and how to transform into an agile organization
...
* Do not neglect mid-level management as their support is vital to the success of the transformation.
...
* Prefer narrow and deep change to a broad and shallow approach.
