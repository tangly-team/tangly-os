...
tags: ["agile", "design"]
params:
  featured: "blog/2019/pics/2019-03-01-head.jpg"
---
...
Culture happens daily through personal interactions.
Putting the right values and mechanisms in place will help move your company in the right direction, but it is not a guaranty for success.

To increase your odds for success, you need to live and breathe your values.
You need to truly believe at all levels in the organization and not compromise on them.

* Advocate for built-in quality.
...
If a value does not make sense, e.g., the value was defined early on, but in hindsight it does not fit with your company, then get rid of it.

== Last Thoughts

Building a great engineering culture is not something that you do.
You cannot cheat.
