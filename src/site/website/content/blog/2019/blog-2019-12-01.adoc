...
* {ref-maven-central} to distribute public binary software artifacts.
* Slack is our preferred chat platform.
...
The partners are still requesting paper interactions with some government agencies and some insurance companies.
We observe a decrease of such physical interactions.
Our partners are steadily, if sometimes slowly, digitizing their workflows.
