...
Such monsters are not born over a one-night coding session.
...
The described approach has been a good practice since the beginning of this millennium.
...
How do you know what the requirements of a specific feature are?
...
* https://en.wikipedia.org/wiki/DevOps[DevOps] starts with git, docker, continuous integration, delivery, and deployment to speed up development and eliminate tedious manual errors.
* Lack of accountability equates to lack of trust.
Your teams are accountable for the quality of your product.
...
Teams ready to learn from the likes of Google could evaluate https://trunkbaseddevelopment.com/[Trunk-Based Development] and consider long-lived branches as waste.
