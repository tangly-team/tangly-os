...
Scrum and the {ref-scrumguide} are silent on how architecture activities are performed during sprints.
We can use the Scrum values, the {ref-scrumguide} and the
