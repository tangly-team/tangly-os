...
. Is there a article charter that lays out the mission and strategic goals?
...
. Can you work on refactoring and clean code without a article backlog item or task?
