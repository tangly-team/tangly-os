...
The article market introduction is a success and you will successfully sell the solution for the next ten years.

How shall you define the software architecture of your article and insure a long living and high quality solution?
The experts tell you the design is emergent, what does it means?

=== LeSS Architecture Observations

The following observations are true for any software article.
...
. The real software architecture evolves (better or worse) every day of the article, as people do programming,
