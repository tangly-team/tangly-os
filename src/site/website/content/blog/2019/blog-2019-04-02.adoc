...
tags: ["organization"]
params:
  featured: "blog/2019/pics/2019-04-02-head.jpg"
---
...
And surely I shall have no virus, trojan and other evils in my workstation.
...
The whole deployment just crashed because the IT department decided to update the virus scanner and associated options.
...
Apple seldom keeps up pre-installed Unix utilities to date.
...
* https://brew.sh/[Homebrew] as a package manager for utilities.
...
* https://www.libreoffice.org/[LibreOffice] is going stronger and better every year.
...
The only big macOS improvement I am waiting for from Apple is that Apple delegates the installation and update of Unix applications and utilities to Homebrew.
