...
tags: ["agile"]
params:
  featured: "blog/2019/pics/2019-09-01-head.jpg"
---
...
In the case of larger common-pool resources, organization is in the form of multiple layers for nested enterprises.
