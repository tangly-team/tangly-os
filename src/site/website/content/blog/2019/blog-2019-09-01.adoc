...
Agile approaches encourage common ownership of artifacts during article development.
...
They ask the article owner if they could refactor a class or invest a few minutes in clean code techniques.
They do not own the internal quality of the article.
...
Worse your article will probably also fail.
...
* Scale to article level using {ref-less}.
