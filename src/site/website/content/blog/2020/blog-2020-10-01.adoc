...
params:
  featured: "blog/2020/pics/2020-10-01-head.jpg"
---
...
Do not get me wrong, there is nothing bad with Markdown; except that no one should probably use it when {ref-asciidoc} and Asciidoctor are available.
I am writing all my documents with {ref-asciidoc}
footnote:[You find tutorials on how to write AsciiDoc documentation and how to use the toolchain on YouTube and Udemy.].
...
<1> Select https://rouge-ruby.github.io/docs/[rouge] as a source highlighter.
