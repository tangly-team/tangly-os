...
Static website generators have strong advantages for technical savvy persons:

* Hosting is cheap.
GitHub, GitLab or Bitbucket pages even hosts static websites for free.
...
You must explicitly enable asciidoctor support by adding following statements in your configuration file
...
Avoid the _html5s_ backend and use instead the _html5_ backend.
