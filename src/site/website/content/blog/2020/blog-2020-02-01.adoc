...
____
CFO to CEO: “What happens if we invest in developing our people and they leave us?” CEO to CFO: “What happens if we don’t, and they stay?”
____
...
Nurture a culture of learning through training on the job, learning from external sources - such as reading https://www.tangly
.net/insights/continuous-learning[high quality blogs] - and formal education - such as bachelor or master courses for example https://www.tangly
.net/insights/continuous-learning/agile-architecture-course[agile architecture] -.
