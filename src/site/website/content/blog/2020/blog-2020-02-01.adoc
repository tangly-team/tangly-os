...
On a previous outcome, we had planned a coding dojo ritual once every two weeks, during which we shared our practices with some perspective over the outcome.
It was an occasion to experiment with new technologies, assess their match for the outcome needs, share new coding techniques, and update our standards together.
