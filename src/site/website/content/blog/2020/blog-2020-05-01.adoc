...
tags: ["java","gradle"]
params:
  featured: "blog/2020/pics/2020-05-01-head.jpg"
---
...
Then you need to make sure you write a proper Java module by providing a module information file.
...
The following configuration is necessary in Gradle to compile, test, execute, and generate Javadoc when using Java 14 preview features.
