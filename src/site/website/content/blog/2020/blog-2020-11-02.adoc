...
. Change the structure. One approach is value streams and article development with cross-functional teams advocated in {ref-less}.
...
Peoples’ behavior _the culture_ is a article of the system; when you change the system peoples’ behavior changes."
____
