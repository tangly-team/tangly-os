...
tags: ["agile", "tangly"]
params:
  featured: "blog/2020/pics/2020-11-02-head.png"
---
...
Agile organizations must be fast-moving and flexible, have rapid response to unexpected obstacles, lead change, and be in touch with customers.
...
It always fails.
Peoples’ behavior _the culture_ is a product of the system; *when you change the system, people’ behavior changes.*"
____
...
_For me, it is similar to the introduction of object-oriented approaches in analysis, design, and realization of software projects.
...
We are delighted with the current results._
