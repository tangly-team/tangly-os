...
tags: ["agile"]
params:
  featured: "blog/2020/pics/2020-12-01-head.jpg"
---
...
. You have a few critical bugs that crash the system or do not have a workaround.
...
Bugs tend to become obsolete pretty quickly in applications that are updated frequently.
...
If you leave them for too long, they can spoil your merchandize and slow down your business.
____
