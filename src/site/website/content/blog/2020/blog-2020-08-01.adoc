...
You often have multiple sources of external identifiers, sometimes overlapping and sometimes no covering all instances.
...
Additional information is available under link:../../docs/bus/businessmodels/.
