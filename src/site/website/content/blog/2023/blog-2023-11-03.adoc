...
cite:[domain-driven-design-distilled,implementing-domain-driven-design,domain-storytelling,-driven-design].
...
[CAUTION]
====
The user interface written with Vaadin will scale up to around ten thousand concurrent users for one server.
...
The huge majority of digital products we build do not need fancy and expensive technologies.

We should build solid products.
