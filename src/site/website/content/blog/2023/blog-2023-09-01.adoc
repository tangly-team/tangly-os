...
params:
  featured: "blog/2023/pics/2023-09-01-head.jpg"
---
...
I also acquired the https://vaadin.com/developers[Vaadin certification] because I regularly developed full-stack applications with Java and https://vaadin.com/[Vaadin].
...
I strongly recommend first mastering Scrum and lean approaches before tackling scaling approaches in software product development.
...
They learnt the theory and proved they understood the concepts.
