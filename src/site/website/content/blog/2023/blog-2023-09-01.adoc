...
I also acquired the https://vaadin.com/learn[Vaadin certification] because I regularly developed full-stack applications with Java and https://vaadin.com/[Vaadin].
