...
The InfoQ DevOps and cloud graph shows DevOps themes investigated in companies during 2022.
Your experts shall apply most or all the approaches documented in the two columns on the right side.

image::2023-03-02-devops-cloud-graph.png[width=780,height=360,role=text-center]
