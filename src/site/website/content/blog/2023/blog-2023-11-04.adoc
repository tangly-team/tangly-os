...
I love to write my documentation and blogs using {ref-asciidoc} notation [1].
...
All course materials are under {ref-cc-by-sa}.

I wanted to provide recommended materials as a list of downloadable documents on the website.

How can you provide this function with {ref-hug} and {ref-docsy}?
...
A document using this functionality is link:../../../ideas/learnings/lectures/[Lectures].
