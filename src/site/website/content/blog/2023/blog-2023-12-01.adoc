...
The plugins have now reached a level of maturity where you can do everything with Gradle
...
Over-customization, while seemingly advantageous in the short run, can result in a convoluted `build.gradle` file.
