...
As Groovy is dynamically typed, it is really hard for IDEs to provide good and fast (!) tooling. Contrarily, parsing and interpreting Maven’s XML is dead simple.
Breaking Changes:::
