...
params:
  featured: "blog/2023/pics/2023-01-01-head.png"
---
...
It often makes sense for businesses to try to tackle a massive software development project while focusing on the current needs of their clients.
...
It results in a dramatic increase in the overall cost of development. +
+
...
+
Remember to account for travel in your budget if you shall expect it from your software development team.
...
Start Searching::
Remember to keep track of your search as you go.
Create a document that records potential companies, their attributes, who you are talking to, what you have learned, and any decisions you have made.
Ask Tough Questions::
