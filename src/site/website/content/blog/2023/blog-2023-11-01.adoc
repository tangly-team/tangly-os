...
params:
  featured: "blog/2023/pics/2023-11-01-head.png"
---

:ref-java-certification: https://www.oracle.com/education/training/java/
...
The current {ref-java-certification}[Java SE 17 Developer] examination process and examination goals are well-documented.
