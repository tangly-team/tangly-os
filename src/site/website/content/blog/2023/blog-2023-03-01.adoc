...
tags: ["agile"]
params:
  featured: "blog/2023/pics/2023-03-01-head.png"
---
...
The Scrum master role is well-documented in the {ref-scrum}.
There are probably more than one million certified Scrum masters in the world.
...
I suggest that you study again the {ref-scrum} when reading the above quote.
Here is the guide statement how a Scrum master should support her organization.
...
- __ Helping employees and stakeholders understand and enact an empirical approach to complex work.__
...
If you read the {ref-scrum} you understand these profiles are facets of the Scrum master role.
...
Teaching, coaching, and mentoring the Scrum team to grasp agility are one of her main responsibilities.
...
To increase the delivered business value, the delivery coach identifies bottlenecks, replaces local optimizations for more generic solutions.
...
I assume it is quite challenging to be a soccer coach if you have no clue what soccer is and how it is played.
...
Butkus, V.
* [[[businessreport, 3]]]
https://www.accenture.com/us-en/insights/technology/business-agility-report-2020[The Business Agility Report, third Edition].
Accenture. 2020
