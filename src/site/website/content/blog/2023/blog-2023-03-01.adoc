...
The counselor coaches the leaders on their agile mindset.
He poinst out, for example, when old-school thinking and behavior hurt on the performance and delivery.
