...
The areas are similar to the ones I check when receiving a CV <<evaluate-tecnical-cvs>>.
...
[[[evaluate-tecnical-cvs, 1]]] link:../../2022/evaluate-technical-cvs/[Evaluate Technical CVs]
