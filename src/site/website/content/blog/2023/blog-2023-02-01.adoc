...
params:
  featured: "blog/2023/pics/2023-02-01-head.jpg"
---
...
- Be clear what you are looking for: make the team better, bring new things, what do they value in code and architecture.
...
The team understands the strengths of the trainees.
...
The employees are using the state of the industry platform to create the products and to collaborate as teams
