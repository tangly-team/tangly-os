...
Switch provider or the computing center of Ticino are examples in Switzerland.
...
The candidate shall have at least a bachelor degree in computer science or related fields.
