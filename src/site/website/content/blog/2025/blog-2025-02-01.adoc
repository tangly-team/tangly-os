...
They advocate a progressive set of leadership principles and management processes proven to free organizations of _command and control_ cultures and improve performance.
...
image::2025-02-01-iterations.png[width=420,height=360,role=left]
