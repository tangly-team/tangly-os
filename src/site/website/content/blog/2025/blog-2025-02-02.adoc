...
Nine years ago, we founded {ref-tangly}.
...
+
_We are a technical agile boutique specialized in the Java stack.
...
+
_We are proud that to have very few regulations.
These documents are all a one-pager.
We expect our collaborators to apply common sense and to act in the best interest of the company and the customer. +
We align collaborators through transparency of their handling and implicit peer review._
Transparency:::
...
Fast feedback loops allow us to adapt our plans and actions This feedback hugely improves collaborator, customer, and stakeholder satisfaction._ +
+
