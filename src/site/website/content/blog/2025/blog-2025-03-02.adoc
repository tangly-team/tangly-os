...
This is a better display than the ones I got in almost all customer offices I work for.
I have a full-size keyboard and a mouse.

_I tried working with two displays, but I never hooked up to this mode._
_I use the notebook display as a monitoring and logging display, and the external display for development activities._
...
We have a git repository, a continuous integration and delivery pipeline, and an agile product board.
Deployments in production are manually triggered through a command line interface.

Documentation is done in {ref-asciidoc} and stored in the git repository.
The content is published as a static website.
