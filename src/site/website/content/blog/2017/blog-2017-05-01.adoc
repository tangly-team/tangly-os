...
params:
  featured: "blog/2017/pics/2017-05-01-head.jpg"
---
...
* Coach the team how to improve, focus and enjoy the work daily. https://en.wikipedia.org/wiki/Flow_(psychology)[Flow] shall be natural for them.
...
First come quality, effectiveness, and only later efficiency.
...
I believe that good practice boosts the right mindset, just as good practice cannot be achieved without the correct mindset.
...
Good coaches practice https://en.wikipedia.org/wiki/Gemba[Gemba] and should restrain from drawing too many slides.
