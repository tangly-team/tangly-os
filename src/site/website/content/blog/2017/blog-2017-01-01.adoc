...
A meeting with eight people and of a duration of 30 minutes costs in Switzerland around 600 Swiss Francs or 500 Euro.
...
The only professional approach is to sign personally a check to the customer for the lost of income.
...
The best practice should only be selected through its ROI.
