...
params:
  featured: "blog/2017/pics/2017-04-01-head.jpg"
---
...
footnote:[The link to article _The Cody Powel test: Eight questions to identify a dull programming job_ were removed.
