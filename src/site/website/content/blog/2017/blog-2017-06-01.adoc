...
Fake Agile::
 ...
 Such a group typically  stops writing documentation, listening to business analysts, article managers and other customers, and dictates its own delivery schedule.
