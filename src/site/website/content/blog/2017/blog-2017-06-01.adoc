...
To maximise the benefits of Agile Software Development, the people, processes and organization that interface and work with the Agile team needs to understand Agile.
