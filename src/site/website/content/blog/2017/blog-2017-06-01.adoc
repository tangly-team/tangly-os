...
tags: ["agile"]
params:
  featured: "blog/2017/pics/2017-06-01-head.jpg"
---

include::../fragments/_config-mb-blog.adoc[]
:ref-standish: https://www.infoq.com/articles/standish-chaos-2015[Standish Group report]
...
{ref-standish} is a proof of this statement.
One picture shows it all.
Look at the failed column.

image::2017-06-01-agile-vs-waterfall.jpg[role=text-center]
...
You can also replace Waterfall with V-Model, {ref-hermes}, RUP, and even sometimes {ref-safe}.
ScrumBut::
...
To maximize the benefits of Agile Software Development, the people, processes and organization that interface and work with the Agile team need to understand Agile.
...
We can state that (see the {ref-scrum})
