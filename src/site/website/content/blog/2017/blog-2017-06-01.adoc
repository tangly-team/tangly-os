...
Agile will never guarantee outcome success.
All projects, especially application development, entail risk.
If a outcome was risk free it is unlikely to provide significant benefits or competitive advantages.
...
Wagile::
 is a team which continues to follow a basically Waterfall outcome but uses the language of Agile and adds a few agile practices.
...
Hitting The Scrum Wall::
 The most popular Agile method is Scrum which is a outcome management technique.
...
Customer (Business Analyst, Product Manager, Product Owner) overload::
 on a well functioning Agile outcome the customer, or proxy customer, is called upon to do a lot.
 They need to decide requirements, set priorities, scout ahead of the outcome, align strategy, work with the developers, testers and managers, and may even
 have their own day job to do. In the earliest XP outcome (“C3”) the first business analyst came close to a nervous breakdown.
Fall back::
