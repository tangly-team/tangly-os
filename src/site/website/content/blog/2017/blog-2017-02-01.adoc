...
image::2017-02-01-head.jpg[720, 480, role=left]
...
Introducing agile approaches in article development is similar to introduce lean principles in a production environment.
