...
tags: ["agile"]
params:
  featured: "blog/2017/pics/2017-11-01-head.jpg"
---
...
Impediment resolution is {ref-kaizen} 改善, a key technique to lean, agile, and Scrum approaches.
The translation is _change for the better_.
...
* Provide a safe to fail environment.
...
The identification step is easy, remember to track impediments and their resolution.
...
It is a mandatory part in the {ref-scrum} 2018 version.
