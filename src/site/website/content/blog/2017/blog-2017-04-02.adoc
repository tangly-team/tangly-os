...
tags: ["agile"]
params:
  featured: "blog/2017/pics/2017-04-02-head.jpg"
---
...
More than 60% of all projects are now realized using an agile approach (to see Agile Trends in Switzerland 2017] by SwissQ
...
The major hurdles when introducing agile approaches at the department or company level are
...
Trust is missing::
Here again we talk about trust, or the beliefs your collaborators are competent and do their best to achieve success.
