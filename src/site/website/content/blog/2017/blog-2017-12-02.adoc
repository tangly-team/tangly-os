...
Such an entry can destroy your carrier potential, for example you are banned to become a board of directors members of a lot of companies.].
...
Often teams forget the consequences of back porting.
