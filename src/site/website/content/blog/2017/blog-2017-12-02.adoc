...
tags: ["design"]
params:
  featured: "blog/2017/pics/2017-12-02-head.jpg"
---
...
The only discussion is the timely *when* and never the statement *if*.
...
For example, you are banned from becoming a board of directors member of a lot of companies.].
...
You should use the actual Java JDK and JVM version because the community is concentrating their effort on the latest version.
...
Having older versions will hinder you from supporting actual timezone changes or extensions in the Unicode standard.

== Training and Community Support

Good training and associated certification are only available for actual versions of languages, frameworks, or libraries.
...
Later, when you adopt a more modern version of your dependencies, you have to remove all this now spurious code and migrate to the built-in concept.
