...
tags: ["agile"]
params:
  featured: "blog/2017/pics/2017-08-01-head.png"
---
...
* Manage a team of software engineers: provide the technical direction, schedule and delegate work, evaluate performance.
...
** __He does not manage and certainly does not micromanage engineers.
