...
* Manage team of software engineers: provide the technical direction, schedule and delegate work, evaluate performance.
...
The technical documentation and feasibility assessments shall be done by the team.
