...
mv $siteDir/agile-architecture-* $siteDir/static/ideas/agilearchitecture
mv $siteDir/architecture-code-scene-* $sitedDir/static/ideas/architecturecodescene

mv $siteDir/content/ideas/agile-architecture-images $siteDir/static/ideas/agilearchitecture/agile-architecture-images
mv $siteDir/content/ideas/architecture-code-scene-images $sitedDir/static/ideas/architecture-code-scene-images/architecture-code-scene-images
