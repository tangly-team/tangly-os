 ...
 * <p> The channel provides the communication medium between publishers and subscribers.
 * Subscribers are asynchronous objects.</p>
 *
 * @param <T> type of the messages handled by the channel
 */
