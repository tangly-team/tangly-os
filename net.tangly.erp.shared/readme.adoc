...
image:https://img.shields.io/maven-central/v/net.tangly/erp/shared.svg[Maven Central]
https://javadoc.io/badge2/net.tangly/bus/javadoc.svg[image://javadoc.io/doc/net.tangly.erp/shared[javadoc]]
...
The documentation can be found under https://tangly-team.bitbucket.io/docs/erp/shared/[Business documentation]
