...
https://javadoc.io/badge2/net.tangly/commons/javadoc.svg[image:https://javadoc.io/doc/net.tangly/dev[javadoc]]
...
The documentation can be found under https://tangly-team.bitbucket.io/docs/dev/[Commons documentation]
