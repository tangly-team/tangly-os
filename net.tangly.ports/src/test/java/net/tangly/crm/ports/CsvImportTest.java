...
import net.tangly.crm.ports.CrmCsvHdl;
...
public class CsvImportTest {
    ...
    void testCsvCrm() throws IOException, URISyntaxException {
        ...
        handler.importNaturalEntities(fromResource("net/tangly/crm/models/naturalEntities.tsv"));
        ...
        handler.importLegalEntities(fromResource("net/tangly/crm/models/legalEntities.tsv"));
        assertThat(crm.legalEntities().size()).isEqualTo(3);

        handler.importEmployees(fromResource("net/tangly/crm/models/employees.tsv"));
        assertThat(crm.employees().size()).isEqualTo(5);

        handler.importContracts(fromResource("net/tangly/crm/models/contracts.tsv"));
