...
public class StoryExtension implements BeforeAllCallback, AfterAllCallback, BeforeEachCallback, ParameterResolver {
    ...
    public void beforeAll(ExtensionContext context) {
        if (!isStory(context)) {
            throw new IllegalStateException("Use @Story annotation to use Story Extension. Class: %s".formatted(context.getRequiredTestClass()));
        }
    ...
    public void beforeEach(ExtensionContext context) {
        if (!isScenario(context)) {
            throw new IllegalStateException("Use @Scenario annotation to use the StoryExtension service. Method: %s".formatted(context.getRequiredTestMethod()));
        }
