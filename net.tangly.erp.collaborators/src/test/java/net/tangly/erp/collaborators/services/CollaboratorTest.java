...
class CollaboratorTest {
    static SwissSocialInsurance of2022_2022() {
        return new SwissSocialInsurance(DateRange.of(LocalDate.of(2021, Month.JANUARY, 1), LocalDate.of(2021, Month.DECEMBER, 31)), new BigDecimal("0.087"),
    ...
    static SwissSocialInsurance of2016_2018() {
        return new SwissSocialInsurance(DateRange.of(LocalDate.of(2021, Month.JANUARY, 1), LocalDate.of(2021, Month.DECEMBER, 31)), new BigDecimal("8.4"),
    ...
    static SwissAccidentInsurance of2016_2022() {
        return new SwissAccidentInsurance(DateRange.of(LocalDate.of(2016, Month.JANUARY, 1), LocalDate.of(2022, Month.DECEMBER, 31)), new BigDecimal("0.0092"),
            new BigDecimal("0.01199"), new BigDecimal("100"), false);
    }

    static SwissPensionFund ofSwissPensionFunds2017() {
        return new SwissPensionFund(DateRange.of(LocalDate.of(2016, Month.JANUARY, 1), LocalDate.of(2022, Month.DECEMBER, 31)), new BigDecimal("0.18456"),
            new BigDecimal("0" + ".5"));
    }

    static SwissPensionFund ofSwissPensionFunds2018() {
        return new SwissPensionFund(DateRange.of(LocalDate.of(2016, Month.JANUARY, 1), LocalDate.of(2022, Month.DECEMBER, 31)), new BigDecimal("0.18736"),
            new BigDecimal("0" + ".5"));
    }

    static SwissPensionFund ofSwissPensionFunds2019() {
        return new SwissPensionFund(DateRange.of(LocalDate.of(2016, Month.JANUARY, 1), LocalDate.of(2022, Month.DECEMBER, 31)), new BigDecimal("0.21562"),
            new BigDecimal("0" + ".5"));
    }
