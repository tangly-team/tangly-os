...
The **tangly erp collaborators** bounded domain component provides regular business model abstractions for business applications written in Java. The component is using records and requires **Java 16 or higher**.
...
```groovy
    implementation "net.tangly.erp:collaborators:0.2.6"
```
