...
@startuml
    salt
    {
        {T
        + **crm**
        ++ //actitivites.tsv//       | tab separated representation of all activities for the company
        ++ //comments.tsv//          | tab separated representation of all comments defined in other entities
        ++ //contracts.tsv//         | tab separated representation of all contracts for the company
        ++ //employees.tsv//         | tab separated representation of all employees for the company
        ++ //interactions.tsv//      | tab separated representation of all interactions for the company
        ++ //legal-entities.tsv//    | tab separated representation of all legal entities for the company
        ++ //natural-entities.tsv//  | tab separated representation of all natural entities for the company
        ++ //subjects.tsv//          | tab separated representation of all subjects for the company
        ++ **vcards**
        +++ //john-doe.vcard//
        +++ ...
        + **invoices**               | contains all invoices grouped by issued date year
        ++ //products.tsv//          | tab separated representation of all products for the company
        ++ **2018**                  | all invoices issued in the year 2018
