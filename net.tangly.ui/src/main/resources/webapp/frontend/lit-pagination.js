/* move file to META-INF/webapp/frontend if a seperate jar component shall be generated */
    ...
    render() {
        return html`
            ...
            <div class="paginator-page-container" ?hidden="${!this.hasPage}">
                ...
                <paper-icon-button icon="pagination-icons:navigate-before" @click="${event => this.onBefore()}"
                                   ?hidden="${!this.hasBefore}"></paper-icon-button>
