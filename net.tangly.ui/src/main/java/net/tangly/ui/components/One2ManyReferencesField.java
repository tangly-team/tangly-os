 ...
 * The view mode is used when the entity is editable. The menu items provide adding and removing of items operations from the collection. If the view of the
