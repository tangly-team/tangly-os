...
image:https://img.shields.io/maven-central/v/net.tangly/erp/apps.svg[Maven Central]
https://javadoc.io/badge2/net.tangly.erp.bus/javadoc.svg[image:https://javadoc.io/doc/net.tangly.erp/apps[javadoc]]
...
The documentation can be found under https://blog.tangly.net/docs/domains/agile/[Business documentation].
