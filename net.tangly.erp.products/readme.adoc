...
image:https://img.shields.io/maven-central/v/net.tangly/erp/products.svg[Maven Central]
https://javadoc.io/badge2/net.tangly/bus/javadoc.svg[image://javadoc.io/doc/net.tangly.erp/products[javaoc]
...
The documentation can be found under https://tangly-team.bitbucket.io/docs/erp/products/[Business documentation]
