...
![Maven Central](https://img.shields.io/maven-central/v/net.tangly/erp/products.svg)
[![javadoc](https://javadoc.io/badge2/net.tangly/bus/javadoc.svg)](https://javadoc.io/doc/net.tangly.erp/products)
...
The **tangly erp products** bounded domain component provides regular business model abstractions for business applications written in Java. The component is using records and requires **Java 16 or higher**.
...
```groovy
    implementation "net.tangly.erp:products:0.2.6"
```

The documentation can be found under [Business documentation](https://tangly-team.bitbucket.io/docs/erp/products/)
