...
The generated file is a CSV file containing the whole ledger account plan. The seperator is TAB.
...
The generated file is a CSV file containing the transaction details. The seperator is TAB.