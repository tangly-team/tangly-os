...
package net.tangly.erp.crm.gravatar;
...
/**
 * A gravatar is a dynamic image resource requested from the gravatar.com server. The class calculates the gravatar url and fetches gravatar images. See
