...
|CRM-004 |As an employee I want to create and modify an opportunity describing how I interact with a legal entity so that an history of all initiatives exists.
The goal of an opportunity is to conclude a contract.

|CRM-005 |As an employee I want to document all activities with entities necessary during an opportunity so that an history of all communicaitons exists
...
|CRM-007 |As a salesperson I want to initiate an opportunity with a legal entity and actively work to conclude a contract with them.
I can have multiple activities to interact with the organization before concluding the opportunity.
An opportunity can be completed successfully or not.
During the timeline of the opportunity the potential and probability of success can change.
