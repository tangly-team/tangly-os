...
image:https://img.shields.io/maven-central/v/net.tangly/facts.svg[Maven Central]
https://javadoc.io/badge2/net.tangly/bus/javadoc.svg[image://javadoc.io/doc/net.tangly.facts/[javadoc]]
