...
using records and requires *{ref-java-current-version} or higher*.
...
The documentation can be found under {ref-tangly-blog-url}/docs/domains/agile/[Business documentation].
